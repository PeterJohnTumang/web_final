...
<head>
    ...
    <title>Plantita, may kakaibang gardening hack para "buhayin" ang tuyong halaman</title>
</head>
    ...
    <section id="article">
        <div class="container">
            <div class="page-container">
                <article class="card">
                    <img src="../img/articles/entertainment7.png" alt="article">
                    <h1 class='l-heading'>Plantita, may kakaibang gardening hack para "buhayin" ang tuyong halaman
                    </h1>
                    <div class="meta">
                        <small>
                    ...
                    <p>
                        Kahit walang green thumb ay pwede pa ring ma-enjoy ang mga halaman.<br><br>

                        Ito ang naisip ni Lisa Harvey, isang 45-year-old mom at personal assistant for children with
                        special needs.<br><br>

                        Ayon kay Lisa, na mula sa Surrey, England, hirap na hirap siyang makabuhay ng halaman. Kadalasan
                        ay namamatay lang ang mga itinatanim niya.<br><br>

                        At dahil naiirita na siya sa palagiang pagkatuyot ng kanyang mga tanim, nakaisip siya ng
                        kakaibang paraan para maresolba ang kanyang problema.<br><br>

                        Ang pinakamagandang paraan para magmukhang maberde at malusog ang kanyang mga halaman ay hindi
                        ang regular na pagdidilig sa mga ito at paglalagay ng pataba sa paso na kinatataniman.<br><br>

                        Sa halip, ginamitan niya ang mga ito ng green spray paint.<br><br>

                        Nag-viral si Lisa matapos niyang ibahagi sa social media ang kakaibang solusyon na ito.
                    </p>
                </article>
