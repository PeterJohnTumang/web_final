...
<head>
    ...
    <title>TAPI allots P16-M to help MSMEs commercialize innovation | PJNews</title>
</head>
    ...
    <section id="article">
        <div class="container">
            <div class="page-container">
                <article class="card">
                    <img src="../img/articles/technology5.jpg" alt="article">
                    <h1 class='l-heading'>TAPI allots P16-M to help MSMEs commercialize innovation</h1>
                    <div class="meta">
                        <small>
                    ...
                    <p>
                        The Technology Application and Promotion Institute (TAPI) has allocated an initial PHP16 million
                        ...
                        Marion Ivy Decena told the Philippine News Agency Thursday.<br><br>

                        The aid, Decena said, was through TAPI's Venture Financing Program (VFP).<br><br>

                        She clarified that repayment for the funding shall be made in one year, in addition to a maximum
                        six months grace period.<br><br>

                        "The loan assistance bears no interest, and has no collateral. We are encouraging our MSMEs to
                        avail of the program," she said, adding that the loan availment is on a first come first served
                        basis.<br><br>

                        TAPI announced the call for proposals for this year's VFP last May 6, with deadline on May 31 at
                        5 p.m.<br><br>

                        The TAPI chief said priority will be given to project proposals on food processing; furniture;
                        gifts, housewares, decors; agriculture, marine, aquaculture; metals and engineering; information
                        and communications technology; and pharmaceuticals and health products.<br><br>

                        Decena said the loan amount should be 70 percent of the proponent's needed funding for
                        commercialization, but the amount of assistance shall not exceed PHP2 million.<br><br>

                        She said that last year, TAPI was able to release PHP8.6 million to aid 13 projects.<br><br>

                        Meanwhile, according to the Department of Science and Technology (DOST), Filipino-owned MSMEs
                        existing for at least three years are eligible for the VFP.<br><br>

                        Proponents should be duly registered sole proprietors, corporations, partnerships or
                        cooperatives with at least 60 percent of ownership belonging to Filipino citizens.<br><br>

                        Eligible proponents should be a technology-based company and must be one of the following: with
                        an active intellectual property filing, an adopter of DOST-generated/funded technology, a
                        previous or current DOST beneficiary, or a technology licensee.<br><br>

                        The DOST also noted that proposed projects must currently be in the commercialization
                        phase.<br><br>

                        The program guidelines can be viewed on TAPI's website.
                    </p>
                </article>
