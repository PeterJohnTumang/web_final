...
<head>
    ...
    <title>Marcos conducts aerial inspection of Mt. Mayon, visit evacuation center in Guinobatan | PJNews</title>
</head>
    ...
    <section id="article">
        <div class="container">
            <div class="page-container">
                <article class="card">
                    <img src="../img/articles/politics4.jpg" alt="article">
                    <h1 class='l-heading'>Marcos conducts aerial inspection of Mt. Mayon, visit evacuation center in
                        Guinobatan</h1>
                    <div class="meta">
                        <small>
                    ...
                    <p>
                        President Ferdinand Marcos Jr. on Wednesday took an aerial inspection of Mayon Volcano, which
                        was placed on Alert Level 3 on Thursday due to high level of unrest. <br> <br>

                        “PBBM conducts aerial inspection of Mt. Mayon and its vicinity,” a story on his Instagram
                        account read.<br> <br>

                        Marcos Jr. was also seen using binoculars to see Mayon up close.<br> <br>

                        Another IG story showed the President inspecting the evacuation center at Guinobatan Community
                        College.<br> <br>

                        He is also expected to visit the evacuation center at San Jose Elementary School in Malilipot
                        town, as well as lead a situation briefing at the Albay Astrodome.
                    </p>
                </article>
