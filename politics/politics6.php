...
<head>
    ...
    <title>Profiling tool: Remulla wants AI to identity human trafficking victims | PJNews</title>
</head>
    ...
    <section id="article">
        <div class="container">
            <div class="page-container">
                <article class="card">
                    <img src="../img/articles/politics6.jpg" alt="article">
                    <h1 class='l-heading'>Profiling tool: Remulla wants AI to identity human trafficking victims</h1>
                    <div class="meta">
                        <small>
                    ...
                    <p>
                        Justice Secretary Jesus Crispin Remulla is considering using artificial intelligence (AI) in
                        intercepting human trafficking victims at the airports. <br><br>

                        “Alam mo yung profiling natin baka kailangan na nating gumamit ng artificial intelligence,” he
                        told reporters on Wednesday (June 14) during the sidelines of the first coordination meeting
                        between the Inter-Agency Council Against Trafficking (IACAT) and stake holders.<br><br>

                        “We’ll try to see if we can use artifical intellligence to vet many of the people who want to
                        leave especially yung prone sa trafficking,” he added.<br><br>

                        Meanwhile, Remulla, who chairs IACAT, appealed to the public for patience in undergoing the
                        screening process before being allowed to board their flgiths.<br><br>

                        “Iniingatan natin yung mga taong maaring matraffic sa ibang bansa,” he pointed out.<br><br>

                        The secretary instead advised the public “mas maaga dumating sa airport para iayos ang papeles
                        para hindi maoffload sa kanilang mga flight.”<br><br>

                        Remulla also warned immigration officers against being involved in human trafficking
                        activities.<br><br>

                        “We’ll put the whole law against those,” he assured.
                    </p>
                </article>
